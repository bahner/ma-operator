...
msg-identity-not-published = Auðkenni finnst ekki á netinu — ef ma er uppsett á þessum tölvu, keyrðu '.ma!discover' og svo '.my.identity:publish @ma'. Skrifaðu '.help.publish' fyrir frekari upplýsingar.
...
help-runtime-discover =   .ma!discover          uppgötva staðbundið keyrsluumhverfi og búa til @ma-samnefni
help-runtime-claim =   .ma!claim             gera tilkall til keyrsluumhverfis með þínu DID
...
help-publish-steps = Skref: keyrðu '.ma!discover' til að finna staðbundið ma, síðan '.my.identity:publish @ma'.
