...
msg-identity-not-published = Auðkenni finnst ekki á netinu — ef 間 er uppsett á þessum tölvu, keyrðu '.ma [port]' og svo '.my.identity!publish @ma'. Skrifaðu '.help/publish' fyrir frekari upplýsingar.
...
help-ma-command =   .ma [port]                   tengjast staðbundnu 間-runtime, lesa /status.json og vista .ma.ctx.*
