...
msg-identity-not-published = Idantite pa jwenn sou entènèt — si ou gen ma ki instalé lokalman, kouri '.ma!discover' epi '.my.identity:publish @ma'. Tape '.help.publish' pou detay.
...
help-runtime-discover =   .ma!discover          dekouvri runtime lokal epi kreye alias @ma
help-runtime-claim =   .ma!claim             reklame pwopriyete runtime avèk DID ou
...
help-publish-steps = Etap: kouri '.ma!discover' pou detekte ma lokal, epi '.my.identity:publish @ma'.
