...
msg-identity-not-published = Idantite pa jwenn sou entènèt — si ou gen 間 ki instalé lokalman, kouri '.ma [port]' epi '.my.identity!publish @ma'. Tape '.help/publish' pou detay.
...
help-ma-command =   .ma [port]                   konekte ak runtime 間 lokal ou, li /status.json, epi sove .ma.ctx.*
...
help-publish-steps = Etap: kouri '.ma [port]' pou detekte 間 lokal, epi '.my.identity!publish @ma'.
