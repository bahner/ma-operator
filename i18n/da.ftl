...
msg-identity-not-published = Identitet ikke fundet online — har du ma installeret lokalt, kør '.my.ma:discover' og derefter '.my.identity:publish @ma'. Skriv '.help.publish' for detaljer.
