...
msg-identity-not-published = Identitas tidak ditemukan secara online — jika ma terpasang secara lokal, jalankan '.ma!discover' lalu '.my.identity:publish @ma'. Ketik '.help.publish' untuk detail.
...
help-runtime-discover =   .ma!discover          temukan runtime lokal dan buat alias @ma
help-runtime-claim =   .ma!claim             klaim kepemilikan runtime dengan DID Anda
...
help-publish-steps = Langkah: jalankan '.ma!discover' untuk mendeteksi ma lokal, lalu '.my.identity:publish @ma'.
