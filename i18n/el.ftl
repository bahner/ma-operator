...
msg-trusted-ma-lookup-wait = Η αναζήτηση αξιόπιστου MA μπορεί να διαρκέσει έως { $seconds } δευτερόλεπτα.
msg-trusted-ma-not-discovered = Trusted MA was not discovered. The lookup may have failed temporarily. Please try `.ma` again.
msg-identity-first-publish = Δημοσιεύεται η ταυτότητα. Αυτό μπορεί να διαρκέσει έως { $seconds } δευτερόλεπτα.
...
msg-identity-not-published = Η ταυτότητα δεν βρέθηκε διαδικτυακά — αν έχεις εγκατεστημένο το 間 τοπικά, εκτέλεσε '.ma: claim [port]' και μετά '.my.identity!publish @ma'. Πληκτρολόγησε '.help/publish' για λεπτομέρειες.
...
err-persist = σφάλμα αποθήκευσης: { $e }
...
help-runtime-discover =   .ma: claim [port]          ανακάλυψη τοπικού περιβάλλοντος εκτέλεσης και δημιουργία ψευδωνύμου @ma
help-runtime-claim =   .ma: claim [port]             διεκδίκηση περιβάλλοντος εκτέλεσης με το DID σας
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   συνδέσου στο τοπικό 間 runtime, διάβασε /status.json και αποθήκευσε .ma.ctx.*
