...
msg-identity-not-published = Η ταυτότητα δεν βρέθηκε διαδικτυακά — αν έχεις εγκατεστημένο το ma τοπικά, εκτέλεσε '.ma!discover' και μετά '.my.identity:publish @ma'. Πληκτρολόγησε '.help.publish' για λεπτομέρειες.
...
help-runtime-discover =   .ma!discover          ανακάλυψη τοπικού περιβάλλοντος εκτέλεσης και δημιουργία ψευδωνύμου @ma
help-runtime-claim =   .ma!claim             διεκδίκηση περιβάλλοντος εκτέλεσης με το DID σας
...
help-publish-steps = Βήματα: εκτέλεσε '.ma!discover' για ανίχνευση του τοπικού ma, μετά '.my.identity:publish @ma'.
