...
msg-identity-not-published = Ɔpsɛt nɔ fɔ gɛt ɔnlain — ɛf 間 dɔn sɛt ɛp fo yɔ, ron '.ma [port]' den '.my.identity!publish @ma'. Rait '.help/publish' fo mɔ infɔmeshɔn.
...
help-ma-command =   .ma [port]                   kɔnɛkt to yu lokal 間 runtime, rid /status.json, ɛn sev .ma.ctx.*
