...
msg-identity-not-published = Ubuzwe abufumanisekanga ku-intanethi — ukuba u-間 ufakiwe endaweni, qhuba '.ma [port]' wulandelise '.my.identity!publish @ma'. Bhala '.help/publish' ngenkcazelo.
...
help-ma-command =   .ma [port]                   qhagamshela kwi 間 runtime yasekuhlaleni, funda /status.json, uze ugcine .ma.ctx.*
