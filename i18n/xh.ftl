...
msg-identity-not-published = Ubuzwe abufumanisekanga ku-intanethi — ukuba u-ma ufakiwe endaweni, qhuba '.ma!discover' wulandelise '.my.identity:publish @ma'. Bhala '.help.publish' ngenkcazelo.
...
help-runtime-discover =   .ma!discover          fumana i-runtime yendawo yile kwaye yila igama elikhawulezayo @ma
help-runtime-claim =   .ma!claim             zimisele nge-runtime nge-DID yakho
...
help-publish-steps = Amanyathelo: qhuba '.ma!discover' ukufumana u-ma wendawo, wulandelise '.my.identity:publish @ma'.
