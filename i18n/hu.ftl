...
msg-identity-not-published = Az identitás nem található online — ha helyileg telepítve van a ma, futtasd '.ma!discover', majd '.my.identity:publish @ma'. Írd '.help.publish' a részletekért.
...
help-runtime-discover =   .ma!discover          helyi futtatókörnyezet felderítése és @ma álnév létrehozása
help-runtime-claim =   .ma!claim             futtatókörnyezet igénybevétele a DID-del
...
help-publish-steps = Lépések: futtasd '.ma!discover' a helyi ma megtalálásához, majd '.my.identity:publish @ma'.
