...
msg-identity-not-published = Az identitás nem található online — ha helyileg telepítve van a 間, futtasd '.ma [port]', majd '.my.identity!publish @ma'. Írd '.help/publish' a részletekért.
...
help-ma-command =   .ma [port]                   kapcsolódj a helyi 間 runtime-hoz, olvasd be a /status.json-t, és mentsd a .ma.ctx.* értékeket
...
help-publish-steps = Lépések: futtasd '.ma [port]' a helyi 間 megtalálásához, majd '.my.identity!publish @ma'.
