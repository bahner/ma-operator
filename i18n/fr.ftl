...
msg-identity-not-published = Identité introuvable en ligne — si 間 est installé localement, exécute '.ma [port]' puis '.my.identity!publish @ma'. Tape '.help/publish' pour les détails.
...
help-ma-command =   .ma [port]                   se connecter au runtime 間 local, lire /status.json et enregistrer .ma.ctx.*
...
help-publish-steps = Étapes : lance '.ma [port]' pour détecter ton 間 local, puis '.my.identity!publish @ma'.
