...
msg-identity-not-published = Identité introuvable en ligne — si ma est installé localement, exécute '.ma!discover' puis '.my.identity:publish @ma'. Tape '.help.publish' pour les détails.
...
help-runtime-discover =   .ma!discover          découvrir l'exécution locale et créer l'alias @ma
help-runtime-claim =   .ma!claim             revendiquer l'exécution avec votre DID
...
help-publish-steps = Étapes : lance '.ma!discover' pour détecter ton ma local, puis '.my.identity:publish @ma'.
