...
msg-identity-not-published = Identidade não encontrada online — se tiver ma instalado localmente, execute '.ma!discover' e depois '.my.identity:publish @ma'. Digite '.help.publish' para detalhes.
...
help-runtime-discover =   .ma!discover          descobrir tempo de execução local e criar alias @ma
help-runtime-claim =   .ma!claim             reclamar tempo de execução com o seu DID
...
help-publish-steps = Passos: execute '.ma!discover' para detetar o seu ma local, depois '.my.identity:publish @ma'.
