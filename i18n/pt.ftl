...
msg-identity-not-published = Identidade não encontrada online — se tiver 間 instalado localmente, execute '.ma [port]' e depois '.my.identity!publish @ma'. Digite '.help/publish' para detalhes.
...
help-ma-command =   .ma [port]                   ligar ao teu runtime 間 local, ler /status.json e guardar .ma.ctx.*
...
help-publish-steps = Passos: execute '.ma [port]' para detetar o seu 間 local, depois '.my.identity!publish @ma'.
