...
msg-auto-published = DID publikigita per loka 間 ({ $url })
...
msg-trusted-ma-lookup-wait = La serĉo de fidinda MA povas daŭri ĝis { $seconds } sekundojn.
msg-trusted-ma-not-discovered = Trusted MA was not discovered. The lookup may have failed temporarily. Please try `.ma` again.
msg-identity-first-publish = Publikigas identecon. Tio povas daŭri ĝis { $seconds } sekundojn.
...
msg-identity-not-published = Identeco ne trovita en la reto — se 間 estas instalita loke, rulu '.ma: claim [port]' poste '.my.identity!publish @ma'. Skribu '.help/publish' por detaloj.
...
discover-hint-endpoint-not-found = Konsilo: endpoint ne trovita. Kontrolu ke 間 montras /status.json ĉe pordo 5003.
discover-hint-server-error = Konsilo: runtime respondis per servila eraro. Kontrolu la 間-protokolojn kaj reprovu.
...
discover-success = 間 malkovrita ĉe { $url }
...
help-config-filter =   .path [nomo]                 listigi nomojn de subŝlosiloj enhavantajn nomon
help-config-full =   .path. [nomo]                listigi plenajn subarbajn valorojn enhavantajn nomon
...
help-runtime-discover =   .ma: claim [port]          malkovri lokan rultemon kaj krei @ma-aliasnomon
help-runtime-claim =   .ma: claim [port]             postuli posedadon de rultemo per via DID
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   konekti al via loka 間-runtime, legi /status.json, kaj konservi .ma.ctx.*
help-ma-publish =   .my.identity!publish @ma     publikigi vian DID-dokumenton por ke aliaj trovu viajn ŝlosilojn kaj endpoint-on
help-ma-security = La plej klara fidlimo estas via propra 間-runtime kun via propra IPFS Desktop/Kubo. Fora publisher povas utili, sed tiam vi fidas je servo de iu alia.
