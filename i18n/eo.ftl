...
msg-identity-not-published = Identeco ne trovita en la reto — se 間 estas instalita loke, rulu '.ma [port]' poste '.my.identity!publish @ma'. Skribu '.help/publish' por detaloj.
...
help-ma-command =   .ma [port]                   konekti al via loka 間-runtime, legi /status.json, kaj konservi .ma.ctx.*
