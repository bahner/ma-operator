...
msg-identity-not-published = Identeco ne trovita en la reto — se ma estas instalita loke, rulu '.ma!discover' poste '.my.identity:publish @ma'. Skribu '.help.publish' por detaloj.
...
help-runtime-discover =   .ma!discover          malkovri lokan rultemon kaj krei @ma-aliasnomon
help-runtime-claim =   .ma!claim             postuli posedadon de rultemo per via DID
...
help-publish-steps = Paŝoj: rulu '.ma!discover' por detekti lokan ma, poste '.my.identity:publish @ma'.
