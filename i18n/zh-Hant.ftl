...
msg-identity-not-published = 未在線找到身份 — 如果本地安裝了 ma，請執行 '.ma!discover' 然後 '.my.identity:publish @ma'。輸入 '.help.publish' 查看詳情。
...
help-runtime-discover =   .ma!discover          探索本地執行階段並建立 @ma 別名
help-runtime-claim =   .ma!claim             用您的 DID 宣告執行階段所有權
...
help-publish-steps = 步驟：執行 '.ma!discover' 偵測本地 ma，然後 '.my.identity:publish @ma'。
