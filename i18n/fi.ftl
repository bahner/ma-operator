...
msg-identity-not-published = Henkilöllisyyttä ei löydetty verkosta — jos ma on asennettu paikallisesti, aja '.ma!discover' sitten '.my.identity:publish @ma'. Kirjoita '.help.publish' yksityiskohtia varten.
...
help-runtime-discover =   .ma!discover          löydä paikallinen ajonaikainen ja luo @ma-alias
help-runtime-claim =   .ma!claim             varaa ajonaikainen DID:lläsi
...
help-publish-steps = Vaiheet: aja '.ma!discover' paikallisen ma:n havaitsemiseksi, sitten '.my.identity:publish @ma'.
