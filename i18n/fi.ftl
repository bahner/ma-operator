...
msg-identity-not-published = Henkilöllisyyttä ei löydetty verkosta — jos 間 on asennettu paikallisesti, aja '.ma [port]' sitten '.my.identity!publish @ma'. Kirjoita '.help/publish' yksityiskohtia varten.
