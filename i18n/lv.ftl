...
msg-identity-not-published = Identitāte nav atrasta tiešsaistē — ja 間 ir instalēts lokāli, izpildi '.ma [port]' un pēc tam '.my.identity!publish @ma'. Raksti '.help/publish' detaļām.
...
help-ma-command =   .ma [port]                   pieslēdzies lokālajam 間 runtime, nolasi /status.json un saglabā .ma.ctx.*
