...
msg-identity-not-published = Identitāte nav atrasta tiešsaistē — ja ma ir instalēts lokāli, izpildi '.ma!discover' un pēc tam '.my.identity:publish @ma'. Raksti '.help.publish' detaļām.
...
help-runtime-discover =   .ma!discover          atklāt lokālo izpildlaiku un izveidot @ma aizstājvārdu
help-runtime-claim =   .ma!claim             pieprasīt izpildlaiku ar savu DID
...
help-publish-steps = Soļi: izpildi '.ma!discover', lai noteiktu vietējo ma, pēc tam '.my.identity:publish @ma'.
