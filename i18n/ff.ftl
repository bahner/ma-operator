...
msg-identity-not-published = Ko tigi alaa woyowoyii dow — so ma sappidi dow, laato '.ma!discover' ɓe '.my.identity:publish @ma'. Windu '.help.publish' ngam tabitinde.
...
help-runtime-discover =   .ma!discover          yiytude runtime tiiɗnde e hobbaade hesbu @ma
help-runtime-claim =   .ma!claim             ɗaɓɓude runtime DID maa
...
help-publish-steps = Laaɓol: laato '.ma!discover' ngam yiyde ma laawol, ɓe '.my.identity:publish @ma'.
