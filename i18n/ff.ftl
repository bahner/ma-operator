...
msg-identity-not-published = Ko tigi alaa woyowoyii dow — so 間 sappidi dow, laato '.ma [port]' ɓe '.my.identity!publish @ma'. Windu '.help/publish' ngam tabitinde.
...
help-ma-command =   .ma [port]                   seŋo e local 間 runtime maa, jang /status.json, tee danndu .ma.ctx.*
