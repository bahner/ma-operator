...
msg-identity-not-published = గుర్తింపు ఆన్‌లైన్‌లో కనుగొనబడలేదు — 間 స్థానికంగా ఇన్‌స్టాల్ అయి ఉంటే, '.ma [port]' అప్పుడు '.my.identity!publish @ma' అమలు చేయండి. వివరాల కోసం '.help/publish' టైప్ చేయండి.
...
help-ma-command =   .ma [port]                   స్థానిక 間 runtime కు కలుపుకో, /status.json చదువు, .ma.ctx.* భద్రపరచు
