...
msg-identity-not-published = గుర్తింపు ఆన్‌లైన్‌లో కనుగొనబడలేదు — ma స్థానికంగా ఇన్‌స్టాల్ అయి ఉంటే, '.ma!discover' అప్పుడు '.my.identity:publish @ma' అమలు చేయండి. వివరాల కోసం '.help.publish' టైప్ చేయండి.
...
help-runtime-discover =   .ma!discover          స్థానిక రన్‌టైమ్ కనుగొనండి మరియు @ma సృష్టించండి
help-runtime-claim =   .ma!claim             మీ DID తో రన్‌టైమ్ క్లెయిమ్ చేయండి
...
help-publish-steps = దశలు: స్థానిక ma కనుగొనడానికి '.ma!discover' అమలు చేయండి, తర్వాత '.my.identity:publish @ma'.
