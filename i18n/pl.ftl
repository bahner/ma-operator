...
msg-identity-not-published = Tożsamość nie znaleziona online — jeśli masz ma zainstalowane lokalnie, uruchom '.ma!discover', a potem '.my.identity:publish @ma'. Wpisz '.help.publish' po szczegóły.
...
help-runtime-discover =   .ma!discover          wykryj lokalne środowisko uruchomieniowe i utwórz alias @ma
help-runtime-claim =   .ma!claim             przejmij środowisko uruchomieniowe swoim DID
...
help-publish-steps = Kroki: uruchom '.ma!discover', aby wykryć lokalny ma, następnie '.my.identity:publish @ma'.
