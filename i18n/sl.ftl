...
msg-identity-not-published = Identiteta ni najdena v omrežju — če imaš 間 nameščen lokalno, poženi '.ma [port]', nato '.my.identity!publish @ma'. Vtipkaj '.help/publish' za podrobnosti.
...
help-ma-command =   .ma [port]                   poveži se z lokalnim 間 runtime, preberi /status.json in shrani .ma.ctx.*
