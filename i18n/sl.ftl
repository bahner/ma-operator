...
msg-identity-not-published = Identiteta ni najdena v omrežju — če imaš ma nameščen lokalno, poženi '.ma!discover', nato '.my.identity:publish @ma'. Vtipkaj '.help.publish' za podrobnosti.
...
help-runtime-discover =   .ma!discover          odkrij lokalno izvajanje in ustvari vzdevek @ma
help-runtime-claim =   .ma!claim             zahtevaj izvajanje s svojim DID-om
...
help-publish-steps = Koraki: poženi '.ma!discover' za zaznavo lokalnega ma, nato '.my.identity:publish @ma'.
