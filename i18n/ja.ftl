...
msg-identity-not-published = オンラインで身元が見つかりません — maがローカルにインストールされている場合、'.ma!discover'を実行してから'.my.identity:publish @ma'を実行してください。詳細は'.help.publish'と入力してください。
...
help-runtime-discover =   .ma!discover          ローカルランタイムを検出し @ma エイリアスを作成
help-runtime-claim =   .ma!claim             自分の DID でランタイムを要求
...
help-publish-steps = 手順：'.ma!discover'でローカルmaを検出し、'.my.identity:publish @ma'を実行してください。
