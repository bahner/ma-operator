...
msg-identity-not-published = Aqoonsigii lama helin onlayn — haddii 間 la rakibay gudaha, orod '.ma: claim [port]' ka dibna '.my.identity!publish @ma'. Qor '.help/publish' faahfaahin.
...
err-persist = khaladka keydinта: { $e }
...
help-runtime-discover =   .ma: claim [port]          ogaw runtime deegaanka oo abuur magaca kale @ma
help-runtime-claim =   .ma: claim [port]             hantida runtime DID-kaagana
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   ku xir 間 runtime-kaaga maxalliga ah, akhri /status.json, kuna kaydi .ma.ctx.*
