...
msg-identity-not-published = Aqoonsigii lama helin onlayn — haddii ma la rakibay gudaha, orod '.ma!discover' ka dibna '.my.identity:publish @ma'. Qor '.help.publish' faahfaahin.
...
help-runtime-discover =   .ma!discover          ogaw runtime deegaanka oo abuur magaca kale @ma
help-runtime-claim =   .ma!claim             hantida runtime DID-kaagana
...
help-publish-steps = Tallaabooyinka: orod '.ma!discover' si aad u ogaato ma gudaha ah, ka dibna '.my.identity:publish @ma'.
