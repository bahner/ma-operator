...
msg-identity-not-published = அடையாளம் இணையத்தில் காணப்படவில்லை — 間 உள்நாட்டில் நிறுவப்பட்டிருந்தால், '.ma [port]' பின்னர் '.my.identity!publish @ma' இயக்கவும். விவரங்களுக்கு '.help/publish' தட்டச்சு செய்யவும்.
...
help-ma-command =   .ma [port]                   உள்ளூர் 間 runtime-இற்கு இணை, /status.json படி, .ma.ctx.* சேமி
