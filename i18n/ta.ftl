...
msg-identity-not-published = அடையாளம் இணையத்தில் காணப்படவில்லை — ma உள்நாட்டில் நிறுவப்பட்டிருந்தால், '.ma!discover' பின்னர் '.my.identity:publish @ma' இயக்கவும். விவரங்களுக்கு '.help.publish' தட்டச்சு செய்யவும்.
...
help-runtime-discover =   .ma!discover          உள்ளூர் இயக்க நேரம் கண்டுபிடிக்கவும் மற்றும் @ma உருவாக்கவும்
help-runtime-claim =   .ma!claim             உங்கள் DID உடன் இயக்க நேரம் கோரவும்
...
help-publish-steps = படிகள்: உள்ளூர் ma கண்டறிய '.ma!discover' இயக்கவும், பின்னர் '.my.identity:publish @ma'.
