...
msg-identity-not-published = Nem bilong yu i no stap long net — sapos ma i istap long komputa bilong yu, ran '.ma!discover' na '.my.identity:publish @ma'. Rait '.help.publish' bilong kisim sampela save.
...
help-runtime-discover =   .ma!discover          painim lokal runtime na mekim alias @ma
help-runtime-claim =   .ma!claim             klemim ownashop bilong runtime long yu DID
...
help-publish-steps = Ol hap: ran '.ma!discover' bilong painim local ma, na '.my.identity:publish @ma'.
