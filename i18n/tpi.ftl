...
msg-identity-not-published = Nem bilong yu i no stap long net — sapos 間 i istap long komputa bilong yu, ran '.ma [port]' na '.my.identity!publish @ma'. Rait '.help/publish' bilong kisim sampela save.
...
help-ma-command =   .ma [port]                   connect long local 間 runtime bilong yu, ritim /status.json, na save .ma.ctx.*
...
help-publish-steps = Ol hap: ran '.ma [port]' bilong painim local 間, na '.my.identity!publish @ma'.
