...
msg-identity-not-published = شناخت آن لائن نہیں ملی — اگر ma مقامی طور پر نصب ہے، تو '.ma!discover' چلائیں پھر '.my.identity:publish @ma'۔ تفصیلات کے لیے '.help.publish' ٹائپ کریں۔
...
help-runtime-discover =   .ma!discover          مقامی رن ٹائم دریافت کریں اور @ma بنائیں
help-runtime-claim =   .ma!claim             اپنے DID سے رن ٹائم کا دعوی کریں
...
help-publish-steps = اقدامات: مقامی ma دریافت کرنے کے لیے '.ma!discover' چلائیں، پھر '.my.identity:publish @ma'۔
