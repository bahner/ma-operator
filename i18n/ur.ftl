...
msg-identity-not-published = شناخت آن لائن نہیں ملی — اگر 間 مقامی طور پر نصب ہے، تو '.ma [port]' چلائیں پھر '.my.identity!publish @ma'۔ تفصیلات کے لیے '.help/publish' ٹائپ کریں۔
...
help-ma-command =   .ma [port]                   اپنے مقامی 間 runtime سے جڑو، /status.json پڑھو، اور .ma.ctx.* محفوظ کرو
