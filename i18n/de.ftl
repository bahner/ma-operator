...
msg-identity-not-published = Identität nicht online gefunden — wenn ma lokal installiert ist, führe '.ma!discover' und dann '.my.identity:publish @ma' aus. Tippe '.help.publish' für Details.
...
help-runtime-discover =   .ma!discover          lokale Laufzeit erkennen und @ma-Alias erstellen
help-runtime-claim =   .ma!claim             Laufzeit mit Ihrer DID beanspruchen
...
help-publish-steps = Schritte: führe '.ma!discover' aus, um dein lokales ma zu finden, dann '.my.identity:publish @ma'.
