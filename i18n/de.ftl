...
msg-identity-not-published = Identität nicht online gefunden — wenn 間 lokal installiert ist, führe '.ma [port]' und dann '.my.identity!publish @ma' aus. Tippe '.help/publish' für Details.
...
help-publish-steps = Schritte: führe '.ma [port]' aus, um dein lokales 間 zu finden, dann '.my.identity!publish @ma'.
