...
msg-identity-not-published = Identiteit niet online gevonden — als je ma lokaal geïnstalleerd hebt, voer '.ma!discover' uit en dan '.my.identity:publish @ma'. Typ '.help.publish' voor details.
...
help-runtime-discover =   .ma!discover          lokale runtime detecteren en @ma-alias aanmaken
help-runtime-claim =   .ma!claim             runtime claimen met uw DID
...
help-publish-steps = Stappen: voer '.ma!discover' uit om je lokale ma te detecteren, dan '.my.identity:publish @ma'.
