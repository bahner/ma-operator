...
msg-identity-not-published = Identiteit niet online gevonden — als je 間 lokaal geïnstalleerd hebt, voer '.ma [port]' uit en dan '.my.identity!publish @ma'. Typ '.help/publish' voor details.
...
help-ma-command =   .ma [port]                   verbind met je lokale 間-runtime, lees /status.json en sla .ma.ctx.* op
...
help-publish-steps = Stappen: voer '.ma [port]' uit om je lokale 間 te detecteren, dan '.my.identity!publish @ma'.
