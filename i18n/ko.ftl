...
msg-identity-not-published = 온라인에서 신원을 찾을 수 없음 — ma가 로컬에 설치되어 있다면, '.ma!discover' 후 '.my.identity:publish @ma'를 실행하세요. 자세한 내용은 '.help.publish'를 입력하세요.
...
help-runtime-discover =   .ma!discover          로컬 런타임 검색 및 @ma 생성
help-runtime-claim =   .ma!claim             DID로 런타임 소유권 청구
...
help-publish-steps = 단계: '.ma!discover'로 로컬 ma를 감지한 후 '.my.identity:publish @ma'를 실행하세요.
