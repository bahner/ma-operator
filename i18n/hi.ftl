...
msg-identity-not-published = पहचान ऑनलाइन नहीं मिली — अगर ma स्थानीय रूप से स्थापित है, तो '.ma!discover' फिर '.my.identity:publish @ma' चलाएं। विवरण के लिए '.help.publish' टाइप करें।
...
help-runtime-discover =   .ma!discover          स्थानीय रनटाइम खोजें और @ma बनाएं
help-runtime-claim =   .ma!claim             अपने DID से रनटाइम का दावा करें
...
help-publish-steps = चरण: स्थानीय ma खोजने के लिए '.ma!discover' चलाएं, फिर '.my.identity:publish @ma'।
