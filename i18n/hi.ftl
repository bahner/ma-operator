...
msg-identity-not-published = पहचान ऑनलाइन नहीं मिली — अगर 間 स्थानीय रूप से स्थापित है, तो '.ma [port]' फिर '.my.identity!publish @ma' चलाएं। विवरण के लिए '.help/publish' टाइप करें।
...
help-ma-command =   .ma [port]                   अपने स्थानीय 間 runtime से जुड़ो, /status.json पढ़ो, और .ma.ctx.* सहेजो
