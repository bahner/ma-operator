...
msg-identity-not-published = Samleiki finnst ikki í netinum — um ma er installerað lokalt, køyr '.ma!discover' og síðan '.my.identity:publish @ma'. Skriva '.help.publish' fyri detaljar.
...
help-runtime-discover =   .ma!discover          finn lokalt keyrsluumhvørvi og stovn @ma-samnefni
help-runtime-claim =   .ma!claim             ger krav á keyrsluumhvørvið við títt DID
...
help-publish-steps = Steg: køyr '.ma!discover' fyri at finna lokalt ma, síðan '.my.identity:publish @ma'.
