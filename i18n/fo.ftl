...
msg-auto-published = DID birt við staðbundið 間 ({ $url })
...
msg-trusted-ma-lookup-wait = Trúgvaða MA-leitan kann taka upp til { $seconds } sekund.
msg-trusted-ma-not-discovered = Trusted MA was not discovered. The lookup may have failed temporarily. Please try `.ma` again.
msg-identity-first-publish = Publiserar samleikan. Hetta kann taka upp til { $seconds } sekund.
...
msg-identity-not-published = Samleiki finnst ikki í netinum — um 間 er installerað lokalt, køyr '.ma: claim [port]' og síðan '.my.identity!publish @ma'. Skriva '.help/publish' fyri detaljar.
...
discover-hint-endpoint-not-found = Ábending: endpoint ikki funnið. Kanna at 間 vísir /status.json á porti 5003.
discover-hint-server-error = Ábending: runtime svaraði við tænaravillu. Kanna 間-loggarnar og royn aftur.
...
discover-success = 間 funnist við { $url }
...
help-runtime-discover =   .ma: claim [port]          finn lokalt keyrsluumhvørvi og stovn @ma-samnefni
help-runtime-claim =   .ma: claim [port]             ger krav á keyrsluumhvørvið við títt DID
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   bind til tín lokala 間-runtime, les /status.json, og goym .ma.ctx.*
help-ma-publish =   .my.identity!publish @ma     almannakunnger títt DID-skjal, so onnur kunnu finna lyklar tínar og endpoint
help-ma-security = Greiðasta álitismarkið er tín egni 間-runtime við tínum egna IPFS Desktop/Kubo. Ein fjarskotin publisher kann vera nyttigur, men tá líta tú á tænastu hjá øðrum.
