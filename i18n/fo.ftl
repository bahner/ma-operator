...
msg-identity-not-published = Samleiki finnst ikki í netinum — um 間 er installerað lokalt, køyr '.ma [port]' og síðan '.my.identity!publish @ma'. Skriva '.help/publish' fyri detaljar.
...
help-ma-command =   .ma [port]                   bind til tín lokala 間-runtime, les /status.json, og goym .ma.ctx.*
...
help-publish-steps = Steg: køyr '.ma [port]' fyri at finna lokalt 間, síðan '.my.identity!publish @ma'.
