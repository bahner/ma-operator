...
msg-identity-not-published = Личность не найдена онлайн — если ma установлен локально, выполни '.ma!discover', а затем '.my.identity:publish @ma'. Напиши '.help.publish' для деталей.
...
help-runtime-discover =   .ma!discover          обнаружить локальную среду и создать @ma
help-runtime-claim =   .ma!claim             заявить права на среду выполнения
...
help-publish-steps = Шаги: выполни '.ma!discover' для обнаружения локального ma, затем '.my.identity:publish @ma'.
