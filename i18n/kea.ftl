...
msg-identity-not-published = Idantidadi ka acha na intanet — si bu ten ma instaladu lokal, kori '.ma!discover' dipus '.my.identity:publish @ma'. Skriva '.help.publish' pa ditailyu.
...
help-runtime-discover =   .ma!discover          diskubrí runtime lokal i kria alias @ma
help-runtime-claim =   .ma!claim             reklama propriedadi di runtime ku bo DID
...
help-publish-steps = Passu: kori '.ma!discover' pa diteta ma lokal, dipus '.my.identity:publish @ma'.
