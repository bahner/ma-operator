...
msg-identity-not-published = Idantidadi ka acha na intanet — si bu ten 間 instaladu lokal, kori '.ma [port]' dipus '.my.identity!publish @ma'. Skriva '.help/publish' pa ditailyu.
...
help-ma-command =   .ma [port]                   liga ku bu 間 runtime lokal, le /status.json, y guarda .ma.ctx.*
...
help-publish-steps = Passu: kori '.ma [port]' pa diteta 間 lokal, dipus '.my.identity!publish @ma'.
