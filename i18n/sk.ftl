...
msg-identity-not-published = Identita nenájdená online — ak máš ma nainštalované lokálne, spusti '.ma!discover' a potom '.my.identity:publish @ma'. Napíš '.help.publish' pre podrobnosti.
...
help-runtime-discover =   .ma!discover          zistiť lokálny runtime a vytvoriť alias @ma
help-runtime-claim =   .ma!claim             prevziať runtime svojím DID
...
help-publish-steps = Kroky: spusti '.ma!discover' na zistenie lokálneho ma, potom '.my.identity:publish @ma'.
