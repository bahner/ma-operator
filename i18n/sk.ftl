...
msg-identity-not-published = Identita nenájdená online — ak máš 間 nainštalované lokálne, spusti '.ma [port]' a potom '.my.identity!publish @ma'. Napíš '.help/publish' pre podrobnosti.
...
help-ma-command =   .ma [port]                   pripoj sa k lokálnemu 間 runtime, prečítaj /status.json a ulož .ma.ctx.*
