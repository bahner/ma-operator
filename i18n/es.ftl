...
msg-identity-not-published = Identidad no encontrada en línea — si tienes 間 instalado localmente, ejecuta '.ma [port]' y luego '.my.identity!publish @ma'. Escribe '.help/publish' para más detalles.
...
help-ma-command =   .ma [port]                   conectar con tu runtime 間 local, leer /status.json y guardar .ma.ctx.*
...
help-publish-steps = Pasos: ejecuta '.ma [port]' para detectar tu 間 local, luego '.my.identity!publish @ma'.
