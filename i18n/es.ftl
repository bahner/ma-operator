...
qr-scan-hint = Apunta la cámara a un código QR de perfil de zion.
...
help-publish-ma = Para publicar necesitas 間 (runtime local) instalado. Conecta ego con IPFS/IPNS en tu nombre.
