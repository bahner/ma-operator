...
msg-identity-not-published = Identidad no encontrada en línea — si tienes ma instalado localmente, ejecuta '.ma!discover' y luego '.my.identity:publish @ma'. Escribe '.help.publish' para más detalles.
...
help-runtime-discover =   .ma!discover          descubrir tiempo de ejecución local y crear alias @ma
help-runtime-claim =   .ma!claim             reclamar tiempo de ejecución con tu DID
...
help-publish-steps = Pasos: ejecuta '.ma!discover' para detectar tu ma local, luego '.my.identity:publish @ma'.
