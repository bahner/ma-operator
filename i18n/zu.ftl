...
msg-identity-not-published = Ubunikazi abufunyanwanga ku-inthanethi — uma u-間 ufakiwe endaweni, qhuba '.ma [port]' bese '.my.identity!publish @ma'. Bhala '.help/publish' ngemininingwane.
...
help-ma-command =   .ma [port]                   xhuma ku-間 runtime yasendaweni, funda /status.json, bese ulondoloza .ma.ctx.*
