...
msg-identity-not-published = Ubunikazi abufunyanwanga ku-inthanethi — uma u-ma ufakiwe endaweni, qhuba '.ma!discover' bese '.my.identity:publish @ma'. Bhala '.help.publish' ngemininingwane.
...
help-runtime-discover =   .ma!discover          thola i-runtime yendawo futhi dala isidlaliso @ma
help-runtime-claim =   .ma!claim             cela ukuphatha i-runtime nge-DID yakho
...
help-publish-steps = Izinyathelo: qhuba '.ma!discover' ukuze uthole u-ma wendawo, bese '.my.identity:publish @ma'.
