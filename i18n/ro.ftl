...
msg-identity-not-published = Identitate negăsită online — dacă ai ma instalat local, rulează '.ma!discover' apoi '.my.identity:publish @ma'. Tastează '.help.publish' pentru detalii.
...
help-runtime-discover =   .ma!discover          descoperă runtime local și creează alias @ma
help-runtime-claim =   .ma!claim             revendică runtime cu DID-ul tău
...
help-publish-steps = Pași: rulează '.ma!discover' pentru a detecta ma-ul local, apoi '.my.identity:publish @ma'.
