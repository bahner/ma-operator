...
msg-identity-not-published = Identiteeti ei leitud veebist — kui 間 on kohalikult installitud, käivita '.ma [port]' ja seejärel '.my.identity!publish @ma'. Kirjuta '.help/publish' üksikasjade jaoks.
...
help-ma-command =   .ma [port]                   ühendu kohaliku 間 runtime-iga, loe /status.json ja salvesta .ma.ctx.*
