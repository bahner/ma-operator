...
msg-identity-not-published = Identiteeti ei leitud veebist — kui ma on kohalikult installitud, käivita '.ma!discover' ja seejärel '.my.identity:publish @ma'. Kirjuta '.help.publish' üksikasjade jaoks.
...
help-runtime-discover =   .ma!discover          avasta kohalik käitusaeg ja loo @ma-alias
help-runtime-claim =   .ma!claim             nõua käitusaeg oma DID-iga
...
help-publish-steps = Sammud: käivita '.ma!discover' kohaliku ma tuvastamiseks, seejärel '.my.identity:publish @ma'.
