...
msg-trusted-ma-lookup-wait = Utafutaji wa MA inayotegemewa unaweza kuchukua hadi sekunde { $seconds }.
msg-trusted-ma-not-discovered = Trusted MA was not discovered. The lookup may have failed temporarily. Please try `.ma` again.
msg-identity-first-publish = Inachapisha utambulisho. Hii inaweza kuchukua hadi sekunde { $seconds }.
