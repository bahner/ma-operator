...
msg-identity-not-published = Utambulisho haukupatikana mtandaoni — ikiwa 間 imewekwa ndani, endesha '.ma [port]' kisha '.my.identity!publish @ma'. Andika '.help/publish' kwa maelezo.
...
help-ma-command =   .ma [port]                   unganisha kwenye 間 runtime yako ya karibu, soma /status.json, na uhifadhi .ma.ctx.*
