...
msg-identity-not-published = Utambulisho haukupatikana mtandaoni — ikiwa ma imewekwa ndani, endesha '.ma!discover' kisha '.my.identity:publish @ma'. Andika '.help.publish' kwa maelezo.
...
help-runtime-discover =   .ma!discover          gundua wakati wa utekelezaji wa ndani na unda jina la kubadilisha @ma
help-runtime-claim =   .ma!claim             dai wakati wa utekelezaji na DID yako
...
help-publish-steps = Hatua: endesha '.ma!discover' kugundua ma ya ndani, kisha '.my.identity:publish @ma'.
