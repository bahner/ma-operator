...
msg-identity-not-published = Kimlik çevrimiçi bulunamadı — 間 yerel olarak yüklüyse, '.ma [port]' ardından '.my.identity!publish @ma' çalıştırın. Ayrıntılar için '.help/publish' yazın.
...
help-ma-command =   .ma [port]                   yerel 間 runtime’a bağlan, /status.json oku ve .ma.ctx.* kaydet
