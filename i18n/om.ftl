...
msg-identity-not-published = Eenyummaan interneetii irraa hin argamne — yoo 間 naannoo irratti fe'ame, '.ma [port]' itti aansuun '.my.identity!publish @ma' oofaa. Bal'ina argachuuf '.help/publish' barreessi.
...
help-ma-command =   .ma [port]                   間 runtime naannoo kee waliin wal qunnami, /status.json dubbisi, .ma.ctx.* immoo kuusi
