...
msg-identity-not-published = Eenyummaan interneetii irraa hin argamne — yoo 間 naannoo irratti fe'ame, '.ma: claim [port]' itti aansuun '.my.identity!publish @ma' oofaa. Bal'ina argachuuf '.help/publish' barreessi.
...
discover-hint-endpoint-not-found = Yaadachiisa: endpoint not found. Check that 間 exposes /status.json on port 5003.
discover-hint-server-error = Yaadachiisa: runtime returned a server error. Check 間 logs and retry.
discover-hint-network = Yaadachiisa: network/connectivity issue. Start 間, verify localhost:5003 is reachable, and allow local HTTP access in the browser.
discover-hint-generic = Yaadachiisa: verify 間 and IPFS Desktop are running, then retry `.ma`.
discover-success = 間 { $url } irratti argame
...
help-runtime-discover =   .ma: claim [port]          runtime naannoo argadhu kaanis moggaasa @ma uumi
help-runtime-claim =   .ma: claim [port]             DID keetiin runtime fudhadhu
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   間 runtime naannoo kee waliin wal qunnami, /status.json dubbisi, .ma.ctx.* immoo kuusi
help-ma-publish =   .my.identity!publish @ma     galmee DID kee maxxansi, namoonni biroon furtuu fi endpoint kee akka argatan
help-ma-security = Daangaan amantaa ifa ta’e 間 runtime kee mataa keetii fi IPFS Desktop/Kubo kee mataa keetii dha. Publisher fagoo ni fayyada ta’a, garuu yeroo sana tajaajila nama biraa irratti hirkata.
