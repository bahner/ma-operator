...
msg-identity-not-published = Eenyummaan interneetii irraa hin argamne — yoo ma naannoo irratti fe'ame, '.ma!discover' itti aansuun '.my.identity:publish @ma' oofaa. Bal'ina argachuuf '.help.publish' barreessi.
...
help-runtime-discover =   .ma!discover          runtime naannoo argadhu kaanis moggaasa @ma uumi
help-runtime-claim =   .ma!claim             DID keetiin runtime fudhadhu
...
help-publish-steps = Tartiiba: ma naannoo argachuuf '.ma!discover' oofaa, itti aansuun '.my.identity:publish @ma'.
