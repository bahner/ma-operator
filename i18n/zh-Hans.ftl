...
msg-identity-not-published = 未在线找到身份 — 如果本地安装了 間，请运行 '.ma [port]' 然后 '.my.identity!publish @ma'。输入 '.help/publish' 查看详情。
...
help-ma-command =   .ma [port]                   连接本地 間 runtime，读取 /status.json，并保存 .ma.ctx.*
