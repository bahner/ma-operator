...
msg-identity-not-published = 未在线找到身份 — 如果本地安装了 ma，请运行 '.ma!discover' 然后 '.my.identity:publish @ma'。输入 '.help.publish' 查看详情。
...
help-runtime-discover =   .ma!discover          发现本地运行时并创建 @ma 别名
help-runtime-claim =   .ma!claim             用您的 DID 声明运行时所有权
...
help-publish-steps = 步骤：运行 '.ma!discover' 检测本地 ma，然后 '.my.identity:publish @ma'。
