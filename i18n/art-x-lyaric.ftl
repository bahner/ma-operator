...
msg-identity-not-published = Ites not inna di web — if ma install inna di machine, run '.ma!discover' den '.my.identity:publish @ma'. Write '.help.publish' fi di details.
...
help-runtime-discover =   .ma!discover          discover local runtime and manifest @ma I-name
help-runtime-claim =   .ma!claim             claim runtime ownership with I and I DID
...
help-publish-steps = Steps: run '.ma!discover' fi find di local ma, den '.my.identity:publish @ma'.
