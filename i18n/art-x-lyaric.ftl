...
msg-identity-not-published = Ites not inna di web — if ma install inna di machine, run '.my.ma:discover' den '.my.identity:publish @ma'. Write '.help.publish' fi di details.
