...
msg-identity-not-published = Identitet ikke funnet online — om du har ma installert lokalt, kjør '.my.ma:discover' og deretter '.my.identity:publish @ma'. Skriv '.help.publish' for detaljer.
...
profile-no-ma = ingen ma-kjøretid konfigurert — kjør '.my.ma:discover' først
...
help-publish-steps = Steg: kjør '.my.ma:discover' for å oppdage din lokale ma, deretter '.my.identity:publish @ma'.
...
gossip-status-not-subscribed = Ikke abonnert
gossip-disabled = Gossip er deaktivert. Sett .my.gossip.enable: true.
gossip-send-not-subscribed = Ikke abonnert på kringkastingskanalen. Bruk .my.gossip:subscribe.
gossip-focus-entered = Kringkastings-fokusmodus. Skriv for say, , for emote, .use for å avslutte.
gossip-unknown-verb = Ukjent gossip-kommando: { $verb }
