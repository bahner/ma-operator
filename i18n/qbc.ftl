...
msg-identity-not-published = Inyalowda pashang nowit kewe na la tube — si ma besh da gut, run '.ma!discover' den '.my.identity:publish @ma'. Slip '.help.publish' fo detay.
...
help-runtime-discover =   .ma!discover          diskova lokal runtime unte mek @ma alias
help-runtime-claim =   .ma!claim             klaim runtime wit yu DID
...
help-publish-steps = Stap: run '.ma!discover' fo find local ma, den '.my.identity:publish @ma'.
