...
msg-identity-not-published = Inyalowda pashang nowit kewe na la tube — si 間 besh da gut, run '.ma [port]' den '.my.identity!publish @ma'. Slip '.help/publish' fo detay.
...
help-ma-command =   .ma [port]                   connect local 間 runtime, read /status.json, save .ma.ctx.*
...
help-publish-steps = Stap: run '.ma [port]' fo find local 間, den '.my.identity!publish @ma'.
