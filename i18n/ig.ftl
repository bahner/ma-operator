...
msg-identity-not-published = Atụfuọla njirimara n'ịntanetị — ọ bụrụ na ma edepụtara n'ebe obibi, bido '.ma!discover' wee mee '.my.identity:publish @ma'. Dee '.help.publish' maka nkọwa.
...
help-runtime-discover =   .ma!discover          chọpụta runtime obibi ma mepụtakwa nchọkwa @ma
help-runtime-claim =   .ma!claim             kwụa akwụ runtime site na DID gị
...
help-publish-steps = Usoro: bido '.ma!discover' iji chọpụta ma nke mpaghara, wee mee '.my.identity:publish @ma'.
