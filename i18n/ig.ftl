...
msg-identity-not-published = Atụfuọla njirimara n'ịntanetị — ọ bụrụ na 間 edepụtara n'ebe obibi, bido '.ma [port]' wee mee '.my.identity!publish @ma'. Dee '.help/publish' maka nkọwa.
...
help-ma-command =   .ma [port]                   jikọọ na 間 runtime nke mpaghara, gụọ /status.json, ma chekwaa .ma.ctx.*
