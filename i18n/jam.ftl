...
msg-identity-not-published = Di identity nuh foun online — if yu have ma install locally, run '.ma!discover' den '.my.identity:publish @ma'. Type '.help.publish' fi details.
...
help-runtime-discover =   .ma!discover          discover local runtime an create @ma alias
help-runtime-claim =   .ma!claim             claim runtime ownership wid yuh DID
