...
msg-identity-not-published = Di identity nuh foun online — if yu have 間 install locally, run '.ma [port]' den '.my.identity!publish @ma'. Type '.help/publish' fi details.
...
help-ma-command =   .ma [port]                   connect to yuh local 間 runtime, read /status.json, an save .ma.ctx.*
