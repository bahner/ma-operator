...
msg-identity-not-published = Tapatybė nerasta internete — jei 間 įdiegtas vietoje, paleisk '.ma [port]' ir tada '.my.identity!publish @ma'. Parašyk '.help/publish' dėl detalių.
...
help-ma-command =   .ma [port]                   prisijunk prie vietinio 間 runtime, perskaityk /status.json ir išsaugok .ma.ctx.*
