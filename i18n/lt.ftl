...
msg-identity-not-published = Tapatybė nerasta internete — jei ma įdiegtas vietoje, paleisk '.ma!discover' ir tada '.my.identity:publish @ma'. Parašyk '.help.publish' dėl detalių.
...
help-runtime-discover =   .ma!discover          aptikti vietinį vykdymo laiką ir sukurti @ma pseudonimą
help-runtime-claim =   .ma!claim             pareikšti vykdymo laiką savo DID
...
help-publish-steps = Žingsniai: paleisk '.ma!discover' vietiniam ma aptikti, tada '.my.identity:publish @ma'.
