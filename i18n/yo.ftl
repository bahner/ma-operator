...
msg-identity-not-published = Ìdánimọ̀ kò rí lórí ayelujara — tí o bá fi 間 sórí kọ̀mpútà rẹ, ṣe '.ma: claim [port]' lẹ́hìn náà '.my.identity!publish @ma'. Tẹ '.help/publish' fún àlàyé.
...
discover-hint-endpoint-not-found = Àbá: endpoint not found. Check that 間 exposes /status.json on port 5003.
discover-hint-server-error = Àbá: runtime returned a server error. Check 間 logs and retry.
discover-hint-network = Àbá: network/connectivity issue. Start 間, verify localhost:5003 is reachable, and allow local HTTP access in the browser.
discover-hint-generic = Àbá: verify 間 and IPFS Desktop are running, then retry `.ma`.
discover-success = a rí 間 ní { $url }
...
help-runtime-discover =   .ma: claim [port]          ṣàwárí runtime ẹbí kí o sì ṣẹ̀dá àpèlé @ma
help-runtime-claim =   .ma: claim [port]             gba ẹ̀tọ́ runtime pẹ̀lú DID rẹ
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   so mọ́ 間 runtime agbègbè rẹ, ka /status.json, kí o sì fi .ma.ctx.* pamọ́
help-ma-publish =   .my.identity!publish @ma     tẹ iwe DID rẹ jáde kí àwọn míì lè rí keys rẹ àti endpoint rẹ
help-ma-security = Ààlà ìgbẹ́kẹ̀lé tó ṣe kedere jù ni 間 runtime tirẹ pẹ̀lú IPFS Desktop/Kubo tirẹ. Publisher tó jìn lè wúlò, ṣùgbọ́n nígbà yẹn o ń gbẹ́kẹ̀lé iṣẹ́ ẹlòmíì.
