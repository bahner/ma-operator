...
msg-identity-not-published = Ìdánimọ̀ kò rí lórí ayelujara — tí o bá fi 間 sórí kọ̀mpútà rẹ, ṣe '.ma [port]' lẹ́hìn náà '.my.identity!publish @ma'. Tẹ '.help/publish' fún àlàyé.
...
help-ma-command =   .ma [port]                   so mọ́ 間 runtime agbègbè rẹ, ka /status.json, kí o sì fi .ma.ctx.* pamọ́
