...
msg-identity-not-published = Ìdánimọ̀ kò rí lórí ayelujara — tí o bá fi ma sórí kọ̀mpútà rẹ, ṣe '.ma!discover' lẹ́hìn náà '.my.identity:publish @ma'. Tẹ '.help.publish' fún àlàyé.
...
help-runtime-discover =   .ma!discover          ṣàwárí runtime ẹbí kí o sì ṣẹ̀dá àpèlé @ma
help-runtime-claim =   .ma!claim             gba ẹ̀tọ́ runtime pẹ̀lú DID rẹ
...
help-publish-steps = Àwọn ìgbésẹ̀: ṣe '.ma!discover' láti rí ma àdúgbò, lẹ́hìn náà '.my.identity:publish @ma'.
