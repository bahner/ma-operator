...
msg-identity-not-published = Identitet nije pronađen online — ako imaš ma instaliran lokalno, pokreni '.ma!discover' i zatim '.my.identity:publish @ma'. Upiši '.help.publish' za pojedinosti.
...
help-runtime-discover =   .ma!discover          otkrij lokalno izvođenje i stvori pseudonim @ma
help-runtime-claim =   .ma!claim             zahtijevaj izvođenje svojim DID-om
...
help-publish-steps = Koraci: pokreni '.ma!discover' za otkrivanje lokalnog ma, zatim '.my.identity:publish @ma'.
