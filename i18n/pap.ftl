...
msg-identity-not-published = Identidad no a haña na internet — si 間 ta instalá lokalmente, drenta '.ma [port]' i despues '.my.identity!publish @ma'. Tik '.help/publish' pa detaljenan.
...
help-ma-command =   .ma [port]                   konektá ku bo 間 runtime lokal, lesa /status.json, i warda .ma.ctx.*
...
help-publish-steps = Pasónan: drenta '.ma [port]' pa detektá e 間 lokal, despues '.my.identity!publish @ma'.
