...
msg-identity-not-published = Identidad no a haña na internet — si ma ta instalá lokalmente, drenta '.ma!discover' i despues '.my.identity:publish @ma'. Tik '.help.publish' pa detaljenan.
...
help-runtime-discover =   .ma!discover          deskubrí runtime lokal i kreá alias @ma
help-runtime-claim =   .ma!claim             reklamá poseeshon di runtime ku bo DID
...
help-publish-steps = Pasónan: drenta '.ma!discover' pa detektá e ma lokal, despues '.my.identity:publish @ma'.
