...
msg-identity-not-published = Không tìm thấy danh tính trực tuyến — nếu ma được cài đặt cục bộ, hãy chạy '.ma!discover' rồi '.my.identity:publish @ma'. Gõ '.help.publish' để xem chi tiết.
...
help-runtime-discover =   .ma!discover          khám phá runtime cục bộ và tạo @ma
help-runtime-claim =   .ma!claim             yêu cầu quyền sở hữu runtime bằng DID
...
help-publish-steps = Các bước: chạy '.ma!discover' để phát hiện ma cục bộ, sau đó '.my.identity:publish @ma'.
