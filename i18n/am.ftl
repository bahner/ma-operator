...
msg-identity-not-published = ህሊና ኦንላይን አልተገኘም — 間 በአካባቢ ከተጫነ፣ '.ma: claim [port]' ከዚያም '.my.identity!publish @ma' ያሂዱ። ዝርዝር ለማየት '.help/publish' ይጻፉ።
...
help-runtime-discover =   .ma: claim [port]          ሁናቴ runtime ፈልግ እና ቅፅል ስም @ma ፍጠር
help-runtime-claim =   .ma: claim [port]             DIDዎ በ runtime ባለቤትነት ጠይቁ
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   ከአካባቢያዊ 間 runtime ጋር ተገናኝ፣ /status.json አንብብ፣ እና .ma.ctx.* አስቀምጥ
