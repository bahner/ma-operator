...
msg-identity-not-published = ህሊና ኦንላይን አልተገኘም — ma በአካባቢ ከተጫነ፣ '.ma!discover' ከዚያም '.my.identity:publish @ma' ያሂዱ። ዝርዝር ለማየት '.help.publish' ይጻፉ።
...
help-runtime-discover =   .ma!discover          ሁናቴ runtime ፈልግ እና ቅፅል ስም @ma ፍጠር
help-runtime-claim =   .ma!claim             DIDዎ በ runtime ባለቤትነት ጠይቁ
...
help-publish-steps = ደረጃዎች: አካባቢያዊ ma ለማግኘት '.ma!discover' ያሂዱ፣ ከዚያም '.my.identity:publish @ma'።
