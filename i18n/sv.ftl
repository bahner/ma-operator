...
msg-identity-not-published = Identitet hittades inte online — om du har 間 installerat lokalt, kör '.ma [port]' sedan '.my.identity!publish @ma'. Skriv '.help/publish' för detaljer.
...
help-ma-command =   .ma [port]                   anslut till din lokala 間-runtime, läs /status.json och spara .ma.ctx.*
