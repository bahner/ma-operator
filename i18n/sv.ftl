...
msg-identity-not-published = Identitet hittades inte online — om du har ma installerat lokalt, kör '.ma!discover' sedan '.my.identity:publish @ma'. Skriv '.help.publish' för detaljer.
...
help-runtime-discover =   .ma!discover          identifiera lokal körtid och skapa @ma-alias
help-runtime-claim =   .ma!claim             gör anspråk på körtid med din DID
...
help-publish-steps = Steg: kör '.ma!discover' för att hitta din lokala ma, sedan '.my.identity:publish @ma'.
