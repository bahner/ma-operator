...
msg-identity-not-published = ไม่พบตัวตนออนไลน์ — ถ้าติดตั้ง 間 ในเครื่องแล้ว ให้รัน '.ma [port]' จากนั้น '.my.identity!publish @ma' พิมพ์ '.help/publish' เพื่อดูรายละเอียด
...
help-ma-command =   .ma [port]                   เชื่อมต่อกับ 間 runtime ในเครื่อง อ่าน /status.json แล้วบันทึก .ma.ctx.*
