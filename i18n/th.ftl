...
msg-identity-not-published = ไม่พบตัวตนออนไลน์ — ถ้าติดตั้ง ma ในเครื่องแล้ว ให้รัน '.ma!discover' จากนั้น '.my.identity:publish @ma' พิมพ์ '.help.publish' เพื่อดูรายละเอียด
...
help-runtime-discover =   .ma!discover          ค้นหา runtime ท้องถิ่นและสร้าง @ma
help-runtime-claim =   .ma!claim             อ้างสิทธิ์ runtime ด้วย DID ของคุณ
...
help-publish-steps = ขั้นตอน: รัน '.ma!discover' เพื่อตรวจหา ma ท้องถิ่น จากนั้น '.my.identity:publish @ma'
