...
msg-identity-not-published = Ba a sami ainihi kan layi ba — idan an shigar da ma cikin gida, gudanar da '.ma!discover' sannan '.my.identity:publish @ma'. Rubuta '.help.publish' don cikakken bayani.
...
help-runtime-discover =   .ma!discover          gano runtime na gida kuma samar da laƙabi @ma
help-runtime-claim =   .ma!claim             ɗauki mallakar runtime da DID ɗinka
...
help-publish-steps = Matakan: gudanar da '.ma!discover' don gano ma na cikin gida, sannan '.my.identity:publish @ma'.
