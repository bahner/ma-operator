...
msg-identity-not-published = Ba a sami ainihi kan layi ba — idan an shigar da 間 cikin gida, gudanar da '.ma [port]' sannan '.my.identity!publish @ma'. Rubuta '.help/publish' don cikakken bayani.
...
help-ma-command =   .ma [port]                   haɗa da 間 runtime na gida, karanta /status.json, kuma ajiye .ma.ctx.*
