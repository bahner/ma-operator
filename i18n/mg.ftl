...
msg-identity-not-published = Tsy hita ny mombamomba amin'ny internet — raha efa napetraka ny 間 eo an-toerana, ampiasao '.ma: claim [port]' ary '.my.identity!publish @ma'. Soraty '.help/publish' ho an'ny antsipiriany.
...
help-runtime-discover =   .ma: claim [port]          ahitana runtime toerana ary mamorona anarana fanampiny @ma
help-runtime-claim =   .ma: claim [port]             alao runtime amin'ny DID anao
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   mifandraisa amin’ny 間 runtime eo an-toerana, vakio /status.json, ary tehirizo .ma.ctx.*
