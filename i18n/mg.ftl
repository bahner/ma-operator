...
msg-identity-not-published = Tsy hita ny mombamomba amin'ny internet — raha efa napetraka ny ma eo an-toerana, ampiasao '.ma!discover' ary '.my.identity:publish @ma'. Soraty '.help.publish' ho an'ny antsipiriany.
...
help-runtime-discover =   .ma!discover          ahitana runtime toerana ary mamorona anarana fanampiny @ma
help-runtime-claim =   .ma!claim             alao runtime amin'ny DID anao
...
help-publish-steps = Dingana: ampiasao '.ma!discover' hikaroana ny ma eo an-toerana, ary '.my.identity:publish @ma'.
