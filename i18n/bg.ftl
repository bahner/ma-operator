...
msg-identity-not-published = Самоличността не е намерена онлайн — ако имаш инсталиран ma локално, изпълни '.ma!discover' и след това '.my.identity:publish @ma'. Напиши '.help.publish' за подробности.
...
help-runtime-discover =   .ma!discover          открива локална среда за изпълнение и създава псевдоним @ma
help-runtime-claim =   .ma!claim             заявява средата за изпълнение с вашия DID
...
help-publish-steps = Стъпки: изпълни '.ma!discover' за намиране на локалния ma, след което '.my.identity:publish @ma'.
