...
msg-identity-not-published = Самоличността не е намерена онлайн — ако имаш инсталиран 間 локално, изпълни '.ma [port]' и след това '.my.identity!publish @ma'. Напиши '.help/publish' за подробности.
...
help-ma-command =   .ma [port]                   свържи се с локалния 間 runtime, прочети /status.json и запази .ma.ctx.*
