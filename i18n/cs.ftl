...
msg-identity-not-published = Identita nenalezena online — máš-li 間 nainstalované lokálně, spusť '.ma [port]' a poté '.my.identity!publish @ma'. Napiš '.help/publish' pro podrobnosti.
...
help-ma-command =   .ma [port]                   připoj se k místnímu 間 runtime, přečti /status.json a ulož .ma.ctx.*
