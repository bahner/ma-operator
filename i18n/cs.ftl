...
msg-identity-not-published = Identita nenalezena online — máš-li ma nainstalované lokálně, spusť '.ma!discover' a poté '.my.identity:publish @ma'. Napiš '.help.publish' pro podrobnosti.
...
help-runtime-discover =   .ma!discover          zjistit lokální runtime a vytvořit alias @ma
help-runtime-claim =   .ma!claim             převzít runtime svým DID
...
help-publish-steps = Kroky: spusť '.ma!discover' pro detekci lokálního ma, poté '.my.identity:publish @ma'.
