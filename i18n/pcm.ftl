...
msg-identity-not-published = Identity no dey online — if 間 don install for your side, run '.ma [port]' den '.my.identity!publish @ma'. Type '.help/publish' for details.
...
help-publish-steps = Steps: run '.ma [port]' to find your local 間, den '.my.identity!publish @ma'.
