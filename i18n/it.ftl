...
msg-identity-not-published = Identità non trovata online — se hai ma installato localmente, esegui '.ma!discover' poi '.my.identity:publish @ma'. Digita '.help.publish' per i dettagli.
...
help-runtime-discover =   .ma!discover          scopri runtime locale e crea alias @ma
help-runtime-claim =   .ma!claim             reclama runtime con il tuo DID
...
help-publish-steps = Passi: esegui '.ma!discover' per rilevare il tuo ma locale, poi '.my.identity:publish @ma'.
