...
qr-scan-hint = Punta la fotocamera su un codice QR di un profilo zion.
...
help-publish-ma = Per pubblicare hai bisogno di 間 (runtime locale) installato. Collega ego a IPFS/IPNS per conto tuo.
