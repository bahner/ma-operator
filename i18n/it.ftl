...
msg-identity-not-published = Identità non trovata online — se hai 間 installato localmente, esegui '.ma [port]' poi '.my.identity!publish @ma'. Digita '.help/publish' per i dettagli.
...
help-ma-command =   .ma [port]                   connetti il runtime 間 locale, leggi /status.json e salva .ma.ctx.*
...
help-publish-steps = Passi: esegui '.ma [port]' per rilevare il tuo 間 locale, poi '.my.identity!publish @ma'.
