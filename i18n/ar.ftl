...
msg-trusted-ma-lookup-wait = قد يستغرق البحث عن MA الموثوق ما يصل إلى { $seconds } ثانية.
msg-trusted-ma-not-discovered = Trusted MA was not discovered. The lookup may have failed temporarily. Please try `.ma` again.
msg-identity-first-publish = يجري نشر الهوية. قد يستغرق هذا ما يصل إلى { $seconds } ثانية.
...
msg-identity-not-published = لم يُعثر على الهوية عبر الإنترنت — إن كان 間 مثبتاً محلياً، شغّل '.ma: claim [port]' ثم '.my.identity!publish @ma'. اكتب '.help/publish' للتفاصيل.
...
help-runtime-discover =   .ma: claim [port]          اكتشاف وقت التشغيل المحلي وإنشاء @ma
help-runtime-claim =   .ma: claim [port]             المطالبة بملكية وقت التشغيل
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   اتصل بوقت تشغيل ma المحلي، واقرأ /status.json، واحفظ .ma.ctx.*
