...
msg-identity-not-published = لم يُعثر على الهوية عبر الإنترنت — إن كان ma مثبتاً محلياً، شغّل '.ma!discover' ثم '.my.identity:publish @ma'. اكتب '.help.publish' للتفاصيل.
...
help-runtime-discover =   .ma!discover          اكتشاف وقت التشغيل المحلي وإنشاء @ma
help-runtime-claim =   .ma!claim             المطالبة بملكية وقت التشغيل
...
help-publish-steps = الخطوات: شغّل '.ma!discover' للكشف عن ma المحلي، ثم '.my.identity:publish @ma'.
