...
msg-identity-not-published = পরিচয় অনলাইনে পাওয়া যায়নি — যদি ma স্থানীয়ভাবে ইনস্টল থাকে, '.ma!discover' তারপর '.my.identity:publish @ma' চালান। বিস্তারিত জানতে '.help.publish' লিখুন।
...
help-runtime-discover =   .ma!discover          স্থানীয় রানটাইম আবিষ্কার করুন এবং @ma তৈরি করুন
help-runtime-claim =   .ma!claim             আপনার DID দিয়ে রানটাইম দাবি করুন
...
help-publish-steps = ধাপ: স্থানীয় ma সনাক্ত করতে '.ma!discover' চালান, তারপর '.my.identity:publish @ma'।
