...
msg-trusted-ma-lookup-wait = বিশ্বস্ত MA অনুসন্ধানে সর্বোচ্চ { $seconds } সেকেন্ড লাগতে পারে।
msg-trusted-ma-not-discovered = Trusted MA was not discovered. The lookup may have failed temporarily. Please try `.ma` again.
msg-identity-first-publish = পরিচয় প্রকাশ করা হচ্ছে। এতে সর্বোচ্চ { $seconds } সেকেন্ড লাগতে পারে।
...
msg-identity-not-published = পরিচয় অনলাইনে পাওয়া যায়নি — যদি 間 স্থানীয়ভাবে ইনস্টল থাকে, '.ma: claim [port]' তারপর '.my.identity!publish @ma' চালান। বিস্তারিত জানতে '.help/publish' লিখুন।
...
# ── ক্রিয়া — ডকুমেন্ট ────────────────────────────────────────────────────
doc-content-empty = { $path } খালি
doc-save-first = { $path } খালি — আগে সংরক্ষণ করুন
...
doc-store-sent = সংরক্ষণ অনুরোধ পাঠানো হয়েছে ({ $id }) → { $publisher }; CID উত্তরের মাধ্যমে আসবে
doc-ipld-store-sent = IPLD সংরক্ষণ অনুরোধ পাঠানো হয়েছে ({ $id }) → { $publisher }; CID উত্তরের মাধ্যমে আসবে
doc-fetch-done = { $cid } আনা হয়েছে → { $path } (চালানো হয়নি)
...
help-msg-send = @alias!msg body @alias:verb args অভিনেতাকে বার্তা পাঠান
...
help-runtime-discover =   .ma: claim [port]          স্থানীয় রানটাইম আবিষ্কার করুন এবং @ma তৈরি করুন
help-runtime-claim =   .ma: claim [port]             আপনার DID দিয়ে রানটাইম দাবি করুন
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   স্থানীয় 間 runtime-এ যুক্ত হও, /status.json পড়ো, এবং .ma.ctx.* সংরক্ষণ করো
...
# ── redigering ─────────────────────────────────────────────────────
term-error = ত্রুটি
term-error-detail = ত্রুটি: { $detail }
