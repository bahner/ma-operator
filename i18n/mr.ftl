...
msg-identity-not-published = ओळख ऑनलाइन सापडली नाही — जर ma स्थानिकपणे स्थापित असेल, तर '.ma!discover' नंतर '.my.identity:publish @ma' चालवा। तपशीलांसाठी '.help.publish' टाइप करा।
...
help-runtime-discover =   .ma!discover          स्थानिक रनटाइम शोधा आणि @ma तयार करा
help-runtime-claim =   .ma!claim             तुमच्या DID ने रनटाइम दाखल करा
...
help-url-msg =   ?msg=<did>                   पूर्व-भरणे: @<did> (साधा संदेश)
...
help-publish-steps = पायऱ्या: स्थानिक ma शोधण्यासाठी '.ma!discover' चालवा, नंतर '.my.identity:publish @ma'।
