...
msg-identity-not-published = ओळख ऑनलाइन सापडली नाही — जर 間 स्थानिकपणे स्थापित असेल, तर '.ma [port]' नंतर '.my.identity!publish @ma' चालवा। तपशीलांसाठी '.help/publish' टाइप करा।
...
help-ma-command =   .ma [port]                   स्थानिक 間 runtime शी जोड, /status.json वाच, आणि .ma.ctx.* जतन कर
