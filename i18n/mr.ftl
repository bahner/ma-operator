...
lang-name = मराठी
label-nick = टोपणनाव
new-identity-nick-help = 間-space साठी टोपणनाव निवडा. ते फक्त टोपणनाव आहे आणि तुम्ही ते कधीही बदलू शकता.
...
btn-show-qr = QR दाखवा
btn-scan-qr = QR स्कॅन करा
qr-scan-hint = कॅमेरा operator प्रोफाइल QR कोडकडे रोखा.
qr-error-camera = कॅमेरा उपलब्ध नाही: { $e }
qr-error-too-large = QR कोडसाठी प्रोफाइल खूप मोठे आहे
...
msg-logged-in = operator v{ $version } — { $username } म्हणून लॉग इन केले
...
msg-auto-published = DID स्थानिक 間 ({ $url }) द्वारे प्रकाशित झाला
...
msg-trusted-ma-lookup-wait = विश्वसनीय MA शोधाला { $seconds } सेकंदांपर्यंत वेळ लागू शकतो.
msg-trusted-ma-not-discovered = Trusted MA was not discovered. The lookup may have failed temporarily. Please try `.ma` again.
msg-identity-first-publish = ओळख प्रकाशित केली जात आहे. याला { $seconds } सेकंदांपर्यंत वेळ लागू शकतो.
...
msg-identity-not-published = ओळख ऑनलाइन सापडली नाही — जर 間 स्थानिकपणे स्थापित असेल, तर '.ma: claim [port]' नंतर '.my.identity!publish @ma' चालवा। तपशीलांसाठी '.help/publish' टाइप करा।
...
btn-eval = चालवा
btn-cancel = रद्द करा
msg-jobs-cancelled = कामे रद्द केली
btn-close = बंद करा
...
discover-hint-endpoint-not-found = सूचना: endpoint not found. Check that 間 exposes /status.json on port 5003.
discover-hint-server-error = सूचना: runtime returned a server error. Check 間 logs and retry.
discover-hint-network = सूचना: network/connectivity issue. Start 間, verify localhost:5003 is reachable, and allow local HTTP access in the browser.
discover-hint-generic = सूचना: verify 間 and IPFS Desktop are running, then retry `.ma`.
discover-success = { $url } वर 間 सापडला
...
# ── क्रिया — दस्तऐवज ──────────────────────────────────────────────────────
doc-content-empty = { $path } रिकामे आहे
doc-save-first = { $path } रिकामे आहे — आधी जतन करा
...
doc-store-sent = संग्रह विनंती पाठवली ({ $id }) → { $publisher }; CID उत्तरामार्फत येईल
doc-ipld-store-sent = IPLD संग्रह विनंती पाठवली ({ $id }) → { $publisher }; CID उत्तरामार्फत येईल
doc-fetch-done = { $cid } आणले → { $path } (चालवले नाही)
...
# ── मदत — शीर्षके ─────────────────────────────────────────────────────────
help-header-operator = ── operator आदेश ────────────────────────────────────────────────────────────
...
help-cmd-history =   .history [n]                 आदेश इतिहास (क्रमिक डुप्लिकेट एकत्रित); पर्यायी n फक्त शेवटच्या n ओळी दाखवते
...
help-msg-send = @alias!msg body @alias:verb args अभिनेत्याला संदेश पाठवा
...
help-runtime-discover =   .ma: claim [port]          स्थानिक रनटाइम शोधा आणि @ma तयार करा
help-runtime-claim =   .ma: claim [port]             तुमच्या DID ने रनटाइम दाखल करा
...
help-ma-command =   .ma: claim [port] / .ma: did:ma:… / .ma                   स्थानिक 間 runtime शी जोड, /status.json वाच, आणि .ma.ctx.* जतन कर
help-ma-publish =   .my.identity!publish @ma     तुझे DID दस्तऐवज प्रकाशित कर, जेणेकरून इतरांना तुझे keys आणि endpoint सापडतील
help-ma-security = सर्वात स्पष्ट trust boundary म्हणजे तुझे स्वतःचे 間 runtime आणि स्वतःचे IPFS Desktop/Kubo. दूरचा publisher उपयोगी ठरू शकतो, पण मग तू दुसऱ्याच्या सेवेला अवलंबून असतोस.
...
err-history-count-invalid = इतिहासाची संख्या धनात्मक पूर्णांक असावी
...
# ── redigering ─────────────────────────────────────────────────────
term-error = त्रुटी
term-error-detail = त्रुटी: { $detail }
...
help-topic-ma = .help/ma                     間-स्पेस, प्रकाशन आणि प्रवेश
...
help-topic-z =   .help/z                      सार्वजनिक आणि खाजगी Scheme मजकूर
...
help-actor-fragment-verb = @actor#entity:verb [args] plugin को
...
help-topic-url =   .help/url                    URL दुव्याद्वारे operator उघडणे
help-topic-i18n = .help/i18n                   तुमच्या ओळखीसाठी भाषा प्राधान्य
help-header-url = ── URL पॅरामीटर ─────────────────────────────────────────────────────────────────
help-url-intro =   पूर्व-भरलेल्या प्राप्तकर्त्यासह operator उघडणारी लिंक शेअर करा:
...
help-publish-ma = प्रकाशित करण्यासाठी 間 (स्थानिक रनटाइम) स्थापित करणे आवश्यक आहे. ते आपल्या वतीने operator ला IPFS/IPNS शी जोडते।
help-publish-steps = पायऱ्या: स्थानिक ma शोधण्यासाठी '.ma: claim [port]' चालवा, नंतर '.my.identity!publish @ma'।
...
msg-timeout = संदेश समयसीमा पार (60s मध्ये कोणतेही उत्तर नाही)
msg-outbox-open-timeout = अभिनेता { $target } पोहोचण्यापलीकडे नाही — { $ms }ms नंतर कनेक्शनची वेळ संपली
msg-outbox-send-timeout = { $target } ला पाठवण्याची वेळ { $ms }ms नंतर संपली — कनेक्शन खंडित झाले असू शकेल
...
# -- Help text -- z and my
help-header-z = ── .z आणि .my ──────────────────────────────────────────────────────────────────────────
help-z-public =   .z.*                       सार्वजनिक किंवा प्रकाशनयोग्य सामग्री; येथे गुपिते साठवू नका
help-z-scheme =   .z.scheme                  प्रारंभावर लोड आणि मूल्यांकन केलेली Scheme स्क्रिप्ट
help-z-control =   .z.scheme                 प्रारंभ स्क्रिप्टची सामग्री तुम्ही स्वतः नियंत्रित करता
help-z-private =   .my.*                     खाजगी स्थानिक कॉन्फिगरेशन; Scheme येथे देखील साठवता येते
help-z-choice =   .z.* / .my.*               सार्वजनिक Scheme साठी .z.* आणि खाजगी Scheme साठी .my.* वापरा

# -- Help text -- zscheme
help-header-zscheme-topic = ── zscheme ──────────────────────────────────────────────────────────────
help-zscheme-intro = zscheme operator आदेशांमध्ये अंतर्भूत Scheme अभिव्यक्तींचे मूल्यमापन करते आणि पाठवण्यापूर्वी निकाल त्या ओळीत जोडते.
